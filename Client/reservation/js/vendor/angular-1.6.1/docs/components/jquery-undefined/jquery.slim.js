...
var i,
	...
	booleans = "checked|selected|read|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
					...
					function resolve( depth, deferred, handler, special ) {
						return function() {
							...
							if ( depth ) {
								...
								// since it's otherwise lost when execution goes read
